...
// $asunto1 = 'Cotización Inmobiliaria Nova - Proyecto: '.$pro_nom;
  ...
  /**************************************/
	...
	// mail("bruno@proyectarse.com",$asunto1,$email_msg1,$headers1);
	...
	$mail_empresa->Username = "web@inmobiliarianova.cl";
	$mail_empresa->Password = "web2015";

	$mail_empresa->From = "contacto@inmobiliarianova.cl";
	$mail_empresa->FromName = "Inmobiliaria Nova";
	$mail_empresa->Timeout = 60;


	$correo_empresa = $correo_cot_cli;
	// $correo_empresa = "bruno@proyectarse.com";
// $correo_empresa1 = "bruno@proyectarse.com";


//------------------------ envio para empresa
$mail_empresa->AddAddress($correo_empresa);
$mail_empresa->AddCC($correo_ven);
$mail_empresa->Subject = "Cotización Inmobiliaria Nova - Proyecto: ".$pro_nom;
$mail_empresa->Body = $email_msg1;
