        ...
        <section id="contenido">
            ...
            <table id="seccion4" style="border-collapse: collapse; width: 800px; margin: 0px auto 10px;">
                ...
                <tr>
                    ...
                    <td width="25%">
                    	<?php echo $valor_viv_cot_formato?>
                    </td>
                    <td width="25%">
                        <?php echo $valor_viv_cot_peso_formato?> <br>
                    </td>
                    <td width="25%">
                ...
                <tr>
                    ...
                    <td width="25%">
                    	<?php echo $credito_cot_formato?>
                    </td>
                    <td width="25%">
                        <?php echo $credito_cot_peso_formato?>  <br>
                    </td>
                    <td width="25%">
                    	<?php echo $credito_cot_porcentaje_formato?>
                    </td>
                </tr>
                <tr>
                	<td width="25%">
                    ...
                    <td width="25%">
                    	<?php echo $subsidio_cot_formato?> 
                    </td>
                    <td width="25%">
                        <?php echo $subsidio_cot_peso_formato?><br>
                    </td>
                    <td width="25%">
                    	<?php echo $subsidio_cot_porcentaje_formato?>
                    </td>
                </tr>
                <tr>
                	<td width="25%">
                    ...
                    <td width="25%">
                    	<?php echo $contado_cot_formato?> 
                    </td>
                    <td width="25%">
                        <?php echo $contado_cot_peso_formato?> <br>
                    </td>
                    <td width="25%">
                    	<?php echo $contado_cot_porcentaje_formato?>
                    </td>
                </tr>
            </table><br>
            <?php  
            ...
            <table id="seccion4" style="border-collapse: collapse; width: 800px; margin: 0px auto 14px;">
                ...
                <tr>
                    ...
                    <td width="25%">
                    	<?php echo $valor_uf_8_formato?>
                    </td>
                    <td width="25%">
                        <?php echo $valor_uf_20_formato?>  <br>
                    </td>
                    <td width="25%">
                    	<?php echo $valor_uf_30_formato?>
                    </td>
                </tr>
                <tr>
                	<td width="25%">
                    ...
                    <td width="25%">
                    	<?php echo $valor_peso_8_formato?>
                    </td>
                    <td width="25%">
                        <?php echo $valor_peso_20_formato?> <br>
                    </td>
                    <td width="25%">
                    	<?php echo $valor_peso_30_formato?>
                    </td>
                </tr>
                <tr>
                	<td width="25%">
                    ...
                    <td width="25%">
                    	<?php echo $valor_uf_8_formato_renta?>
                    </td>
                    <td width="25%">
                        <?php echo $valor_uf_20_formato_renta?> <br>
                    </td>
                    <td width="25%">
                    	<?php echo $valor_uf_30_formato_renta?>
                    </td>
                </tr>
                <tr>
                	<td width="25%">
                    ...
                    <td width="25%">
                    	<?php echo $valor_peso_8_formato_renta?>
                    </td>
                    <td width="25%">
                        <?php echo $valor_peso_20_formato_renta?> <br>
                    </td>
                    <td width="25%">
                    	<?php echo $valor_peso_30_formato_renta?>
                    </td>
                </tr>
            </table>
